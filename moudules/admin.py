...
'adm/index.php','adm.php','affiliate.php','adm_auth.php','memberadmin.php','administratorlogin.php','cpanel','adm_auth.php',
'default','root','security','admin_db.php','adminfaq.php','admincp.php','myadmin.asp','admin.phtml','All.php','ClientLogin.php','admin_users.php',
'admin.inc.php','admin_forums.php','admin_menu.php','functions_admin.php','']
print

def adminm():
	try:
		start = colored("\n\033[92m[\033[91mpanel\033[92m]\033[93m$>")
		joker = raw_input(start+"\n\t\033[92m Enter Your Domain \033[91m:")
		...
		for admin in admin_path:
			...
			print "\n\033[1;93m[%s]: \033[91m[\033[92m%s\033[91m]-\033[93m[%s]" % (response.reason, admin, response.status,)
